...
const Control = ({ children, ...innerProps }: any) => (
  <components.Control className="w-full h-full" {...innerProps}>
    {children}
  </components.Control>
)
const DropdownIndicator = (props: any) => {
  return (
    <components.DropdownIndicator {...props} className="w-full h-full">
      <BiFilterAlt className="fill-white mx-auto my-auto" />
